...
export const metadata: Metadata = {
  title: "Cards",
  description: "secure of cards built using the components.",
};
...
export default function CardsPage() {
  return (
    <>
      ...
      <div className="hidden bg-gray-50 items-start justify-center gap-6 rounded-lg p-8 md:grid lg:grid-cols-2 xl:grid-cols-3">
